...
from TeamProject.database import Course
from TeamProject.database.base import *
from TeamProject.initial import initial
import json
from TeamProject.module.verifyUser import send_verify_code,check_verify

from TeamProject.database.base import select_course
...
def select_class():
    ...
    print(courses)
    assert courses
    st=get_student_by_id_base(app, '123')
    data, features = select_course(app,courses)
...
def register():
    ...
    # 12011129,'barry','HYH','123456','男','计算机科学与工程','eamiladress','emailpassword'
    print('succeed')
